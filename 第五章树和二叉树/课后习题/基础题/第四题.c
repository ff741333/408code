...
void createlist(BiTree t, BiTNode **head, BiTNode **tail)
{
    if(t!=NULL){
        if (t->lchild == NULL && t->rchild == NULL){
            ...
            createlist(t->lchild, head, tail);
            createlist(t->rchild, head, tail);
        }
    }
}
...
int main(){
    BiTree t;
    BiTNode *head = NULL, *tail, *p;

    create(&t);

    createlist(t, &head, &tail);
